...
import '@/languages/helpers/inlineCompletionService';
import AISettingPanel from '@/extensions/workbench/aiSettingPanel';
...
export const mainExt: IExtension = {
	...
	activate(molecule) {
		...
		monaco.editor.onDidCreateEditor((editor) => {
			...
			// 初始化 AI 配置
			const aiConfigManager = getAIConfigManager();
					...
					<div className="activityBar-imgIcon">
						...
						>
							<path
								fillRule="evenodd"
								clipRule="evenodd"
								d="M12 2C12.5523 2 13 2.44772 13 3V4.08296C14.8638 4.35888 16.5506 5.23108 17.8284 6.5C18.0236 6.69526 18.3402 6.69526 18.5355 6.5L19.2426 5.79289C19.6331 5.40237 20.2663 5.40237 20.6568 5.79289C21.0474 6.18342 21.0474 6.81658 20.6568 7.20711L19.9497 7.91421C20.0169 8.02369 20.0814 8.13507 20.1432 8.24825C20.8476 9.50534 21.2647 10.9193 21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4L21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4L21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4L21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4L21.3433 12.4C21.3433 12.4 21.3433 12.4 21.3433 12.4L22 12.4C22.5523 12.4 23 12.8477 23 13.4C23 13.9523 22.5523 14.4 22 14.4H21.3433C21.2647 15.8807 20.8476 17.2947 20.1432 18.5517C20.0814 18.6649 20.0169 18.7763 19.9497 18.8858L20.6568 19.5929C21.0474 19.9834 21.0474 20.6166 20.6568 21.0071C20.2663 21.3976 19.6331 21.3976 19.2426 21.0071L18.5355 20.3C18.3402 20.1047 18.0236 20.1047 17.8284 20.3C16.5506 21.5689 14.8638 22.4411 13 22.717V23.8C13 24.3523 12.5523 24.8 12 24.8C11.4477 24.8 11 24.3523 11 23.8V22.717C9.13615 22.4411 7.44939 21.5689 6.17157 20.3C5.97631 20.1047 5.65973 20.1047 5.46447 20.3L4.75736 21.0071C4.36684 21.3976 3.73367 21.3976 3.34315 21.0071C2.95262 20.6166 2.95262 19.9834 3.34315 19.5929L4.05025 18.8858C3.98306 18.7763 3.91861 18.6649 3.85684 18.5517C3.15237 17.2947 2.73527 15.8807 2.65674 14.4H2C1.44772 14.4 1 13.9523 1 13.4C1 12.8477 1.44772 12.4 2 12.4H2.65674C2.73527 10.9193 3.15237 9.50534 3.85684 8.24825C3.91861 8.13507 3.98306 8.02369 4.05025 7.91421L3.34315 7.20711C2.95262 6.81658 2.95262 6.18342 3.34315 5.79289C3.73367 5.40237 4.36684 5.40237 4.75736 5.79289L5.46447 6.5C5.65973 6.69526 5.97631 6.69526 6.17157 6.5C7.44939 5.23108 9.13615 4.35888 11 4.08296V3C11 2.44772 11.4477 2 12 2ZM12 7C9.23858 7 7 9.23858 7 12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12C17 9.23858 14.7614 7 12 7Z"
								fill="currentColor"
							/>
						</svg>
					</div>
